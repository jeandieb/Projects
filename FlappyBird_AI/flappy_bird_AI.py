...
def draw_window(win, birds, pipes, base, score, generation):
    ...
    for bird in birds:
        bird.draw(win)
    score_text = STAT_FONT.render('Score: ' + str(score), 1, (225,225,225))
    win.blit(score_text, (WIN_WIDTH - 10 - score_text.get_width(), 10))
   
    generation_text = STAT_FONT.render('Gen: ' + str(generation), 1, (225,225,225))
    win.blit(generation_text, (10, 10))

    alive_birds_text = STAT_FONT.render('Alive: ' + str(len(birds)), 1, (225,225,225))
